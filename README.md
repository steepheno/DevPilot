...
**Devpilot**은 사용자가 프로젝트 개발 환경과 Git 정보를 입력하면 자동으로 배포 스크립트를 작성하고, 진행 상황 로그를 제공합니다. <br/>
서비스 이용 도중 궁금한 사항이나 에러를 해결할 수 있도록 AI 챗봇 기능을 지원합니다. <br/>
Jenkins GUI와 유사한 UI를 구현함으로써 추후 사용자가 Jenkins로 CI/CD 파이프라인을 구축할 때 어려움을 덜 겪도록 개발했습니다. <br/>
<br/>
...
* Hugging Face 플랫폼의 오픈소스 LLM을 FastAPI로 구현하였으며, Jenkins 공식 문서를 크롤링 후 RAG 기법을 적용했습니다.
